...
<div class="card shadow mb-4">
    ...
    <div class="card-header py-3">
        <div class="row">
            ...
            <div class="col-sm-12 col-md-6  text-align-right">
                <a href="{{ route('breaking_news-add') }}" title="Add New Record" class="btn btn-success btn-icon-split">
    ...
    <div class="card-body">
        ...
        <div class='searchForm'>
            @include('breaking_news.partials.search')
        </div>
        <!--end search form -->
        
        <!-- listing table start -->
        <div id="listRecords" class="table-responsive">
            @include('breaking_news.partials.listing')
        </div>
        <!-- end listing table -->
